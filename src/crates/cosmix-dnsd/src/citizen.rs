...
//!      (provisions `cosmix-dnsd` UID/GID 506, SPEC-10 v1.4.6);
...
/// SPEC-10 v1.4.6 registered daemon-identity facts for `cosmix-dnsd`.
...
mod tests {
    ...
    fn spec10_identity_matches_checked_in_sysusers_fragment() {
        ...
        // generated from: `... cosmix-daemon-identity v1.4.6.`
        let version = conf
            .lines()
