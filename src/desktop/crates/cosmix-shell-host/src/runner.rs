                ...
                Phase::Begin => spans.begin(|| {
                    span(
                        match event.operation {
                            ...
                            Operation::QueueFenceLock => "wgpu_submit_fence_lock",
                            Operation::QueueCommandPrep => "wgpu_submit_command_prep",
                            Operation::QueuePendingWrites => "wgpu_submit_pending_writes",
                            Operation::QueueHalSubmit => "wgpu_submit_hal",
                            Operation::QueueHalBookkeeping => "wgpu_submit_hal_bookkeeping",
                            Operation::QueueVkSubmit => "wgpu_submit_vk",
                            Operation::QueueMaintenance => "wgpu_submit_maintenance",
