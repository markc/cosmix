...
the full patched Unix file SHA-256 and both hunk SHA-256 values. `cosmix-term-core`'s
`teletypewriter_patch_guard` tests (the crate that owns the PTY code) check these plus the rio-vt/corcovado pins
