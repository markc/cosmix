...
carousel to the page. Either way the panel then asks for the keyboard exactly
as a focus-cycle stop does: its layer requests exclusive keyboard
interactivity until focus has landed and left, Escape, or the grant times out,
so typing goes to the activated sub-panel. The reply is
